lspotify portable build

Run lspotify.exe from this directory (it launches lspotify-player-host.exe
...
This build stores its settings, cache, and logs in %LOCALAPPDATA%\lspotify. No offline audio is
