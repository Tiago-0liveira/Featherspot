...
3. Set your public Client ID in Mellowdeck onboarding. Do not create or embed a client secret.
...
then shuts down. The `user-read-email` scope is requested only because the Web Playback SDK requires it; Mellowdeck never reads or stores the address.
