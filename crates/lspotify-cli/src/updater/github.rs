...
pub const DEFAULT_REPO: &str = "Tiago-0liveira/lspotify";
...
mod tests {
    ...
    fn parse_valid_release_json() {
        let json = r#"{
            ...
            "assets": [
                {
                    "name": "lspotify-windows-x86_64.exe",
                    "browser_download_url": "https://example.com/lspotify.exe",
                    "size": 1024
                },
                {
                    "name": "checksums.txt",
        ...
        assert_eq!(release.assets[0].name, "lspotify-windows-x86_64.exe");
    }
